...
<template>
    <ClientOnly>
        ...
        <section v-bind="$attrs" class="demo-container">
            <div class="demo-slot" v-if="mounted" ref="slotWrapper" :class="{ compact, iframe }">
                <slot></slot>
            </div>
            ...
            <div class="demo-actions">
                ...
                <div v-if="files.length > 0" class="demo-buttons" style="margin-left: auto">
                    ...
                    &nbsp;&nbsp;&nbsp;
                    <div class="tooltip">
                        <img class="icon" @click="sourceVisible = !sourceVisible" src="./icons/source_code.svg"
                            alt="code" />
            ...
            <template v-if="sourceVisible">
                ...
                <div v-else-if="currentFile?.codeStr" key="raw"
                    :class="`language-${currentFile.language} source-code-wrapper`" style="color: white">
