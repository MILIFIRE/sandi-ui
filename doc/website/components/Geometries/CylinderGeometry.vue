<template>
    <div class="slider-demo-block">
      <span class="demonstration">radiusTop</span>
      <el-slider v-model="radiusTop" :max="30" :min="1" :step="1" />
    </div>
    <div class="slider-demo-block">
      <span class="demonstration">radiusBottom</span>
      <el-slider v-model="radiusBottom" :max="30" :min="1" :step="1" />
    </div>
    <div class="slider-demo-block">
    ...
    <div class="slider-demo-block">
      ...
      <el-slider v-model="radialSegments" :max="40" :min="1" :step="1" />
    </div>
    <div class="slider-demo-block">
...
export default {
  setup() {
    ...
    const thetaLength = ref(2 * Math.PI);
    setInterval(() => {
      r.x += 0.005;
      r.y += 0.005;
      r.z += 0.005;
